        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-brand-steel">
            <p className="mb-12 text-xl leading-relaxed">
              {t('legal.privacidad.intro')}
            </p>

            <div className="space-y-12">
              <section>
                <h2 className="text-2xl font-bold text-brand-dark mb-4">{t('legal.privacidad.finalidad')}</h2>
                <p className="leading-relaxed">
                  {t('legal.privacidad.finalidadDesc')}
                </p>
              </section>

              <section>
                <h2 className="text-2xl font-bold text-brand-dark mb-4">{t('legal.privacidad.derechos')}</h2>
                <p className="leading-relaxed">
                  {t('legal.privacidad.derechosDesc')}
                </p>
              </section>
            </div>
          </div>
